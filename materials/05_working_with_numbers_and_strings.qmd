...
::: {.callout-exercise}
#### Exercise 1: Assigning Variables and Checking Data Types
{{< level 1 >}}
...
::: {.callout-exercise}
#### Exercise 2: Using Numeric Built-in Functions
{{< level 1 >}}
...
::: {.callout-exercise}
#### Exercise 3: Temperature Statistics Calculation
{{< level 2 >}}

A weather station in Edinburgh recorded daily maximum temperatures (°C) over five days as follows: `14.2`, `16.8`, `12.5`, `18.1`, and `15.0`.
...
::: {.callout-exercise}
#### Exercise 4: Exploring String Methods and Documentation
{{< level 1 >}}
...
::: {.callout-exercise}
#### Exercise 5: Joining Words into a Formatting Sentence
{{< level 1 >}}
...
::: {.callout-exercise}
#### Exercise 6: Shopping Basket & Loyalty Discount
{{< level 2 >}}
...
::: {.callout-exercise}
#### Exercise 7: Event Registration & Ticket Summary
{{< level 2 >}}
...
Average Temperature (raw): 15.32 °C
...
These exercises aer slightly more difficult and will use all you have learnt so far in the course. In real-world applications, specifications are described in plain language. Practice converting verbal instructions into Python code using numerical functions, string methods, and f-strings.
