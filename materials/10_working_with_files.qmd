...
::: {.callout-exercise}
#### Exercise 2: Writing, reading and appending to a file
{{< level 1 >}}
...
::: {.callout-exercise}
#### Exercise 3: Organising files with `shutil` and `os`
{{< level 2 >}}
...
::: {.callout-exercise}
#### Exercise 4: Reopening and appending to a file
{{< level 1 >}}
...
::: {.callout-exercise}
#### Exercise 5: Discussion — why use both `with` and `try`/`except`?
{{< level 2 >}}
